...
**/
function streamAssetsForImport(sourceUrls, targetSite, {concurrency, overwriteLayouts, headers} = {}) {
 ...
 * @return {Stream}
 */
function importUrl(sourceUrl, targetSite, {concurrency, key, headers, overwriteLayouts, touchup} = {}) {
