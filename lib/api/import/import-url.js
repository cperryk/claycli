 ...
 * @return {Stream}
 */
function importUrl(sourceUrl, targetSite, {concurrency, key, headers, overwriteLayouts, ignoreLayouts, touchup} = {}) {
  return streamAssetsForImport(sourceUrl, targetSite, {concurrency, headers, overwriteLayouts})
    .flatMap(asset => importApi.importAsset(asset, {key, concurrency, headers, touchup}));
}
